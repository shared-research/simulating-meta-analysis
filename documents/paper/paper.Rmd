...
(ref:res-random-effects-i2) Summary of the *random-effect* model fixing the $I^2$ value. Parameters are the same as described in Table \@ref(tab:res-random-effects).
